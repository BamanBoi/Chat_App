...
const Shortcuts = ({ open, handleClose }) => {
    return (
        <>
            <Dialog fullWidth maxWidth="md" open={open} onClose={handleClose} keepMounted sx={{ p: 4 }}>
                <DialogTitle>
                   Keyboard Shortcuts
                </DialogTitle>
                <DialogContent sx={{mt:4}}>
                   <Grid container spacing={3}>
                    ...
                    <Grid key={key} container item xs={6}>
                       <Stack justifyContent={"space-between"} spacing={3} direction={"row"} alignItems={"center"} sx={{width:"100%"}}>
