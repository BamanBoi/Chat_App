...
const ChatElement =({id, name,img,msg,time,unread,online}) =>{
    ...
    return (
      <Box sx={{widht:"100%",borderRadius:1,backgroundColor:theme.palette.mode === "light" ? "#fff" :theme.palette.background.default,}} p={2}>
       ...
       <Stack spacing={2} alignItems="center">
          <Typography sx={{fontWeight:650}} variant='caption'>{time}</Typography>
