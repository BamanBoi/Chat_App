import { Avatar, Box, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Divider, Icon, IconButton, Slide, Stack, Typography, useTheme } from '@mui/material'
       ...
       <Stack sx={{height:"100%" ,position:"relative",flexGrow:1,overflowY:"scroll"}} p={3} spacing={3}>
        <Stack alignItems={"center"} direction={"row"} spacing={2}>
              ...
              <Stack spacing={0.5}>
                ...
                <Typography variant='body2' fontWeight={500}>{'+91 111 1111 1111'}</Typography>
              </Stack>
          </Stack>
         ...
         <Stack spacing={0.5}>
          ...
          <Typography variant='body2'>I am sexy</Typography>
         </Stack>
         <Divider/>
         ...
         <Stack>
          ...
          <Stack direction={"row"} spacing={2} alignItems={"center"}>
          <Stack spacing={0.5}>
            <Typography variant='subtitle2'>Baman Boi</Typography>
            <Typography variant='caption'>Baman Boi</Typography>
          </Stack>
          </Stack>
         </Stack>
         <Stack direction={"row"} alignItems={"center"} spacing={2}>
